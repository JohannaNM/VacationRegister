...
namespace VacationRegister.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public LeaveTypesController(VacRegDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LeaveTypeId,TypeofLeave,LeaveDescr")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaveTypeId,TypeofLeave,LeaveDescr")] LeaveType leaveType)
        {
